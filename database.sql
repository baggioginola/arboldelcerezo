...
values('Mario','Cuevas','mariocue@herbalife.com',md5('4rb01123345'),true,0,now(),now());
...
create table cart_productos(id int(11) not null primary key auto_increment, id_cart int(11),id_producto int(11), cantidad int(11),
